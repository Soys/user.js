...
(function() {
    ...
    acpart[5].innerHTML = acpart[5].innerHTML + '<div class="mainer"><a href="#area=post-video" class="tab"><i class="icon"></i>视频投稿</a><a href="#area=post-article" class="tab"><i class="icon"></i>文章投稿</a><a href="#area=post-history" class="tab"><i class="icon"></i>过往投稿</a><a href="https://member.acfun.cn/upload-video" class="tab"><i class="icon"></i>视频投稿(新)</a><a href="https://member.acfun.cn/post-article" class="tab"><i class="icon"></i>文章投稿(新)</a></div>';
    // Your code here...
})();
